...
export default function Page() {
    ...
    interface ApproverList extends EmployeeList {
        level: number;
    }
    ...
    const [approver, setApprover] = useState<ApproverList[]>([
    ...
    const getAvailableOptions = (currentIndex: number, Lists: any) => {
                ...
                >
                    ...
                    <div className="overflow-y-auto p-6 flex flex-col gap-5 min-h-[80vh]" style={{ scrollbarWidth: "none" }}>
                        {type == "ผู้อนุมัติ" && List.map((app: any, index: number) => (
                            <div
                                key={index}
                                className={`flex pl-4 items-center mt-2 gap-2 `}
                            >
                                ...
                                <Select
                                    ...
                                    className="w-1/2 rounded-lg basic-multi-select"
                                    options={getAvailableOptions(index, approver)}
                        ...
                        {type == "ผู้ดำเนินการ" && List.map((app: any, index: number) => (
                            ...
                            >
                                ...
                                <Select
                                    ...
                                    placeholder="โปรดเลือกผู้อนุญาติเอกสาร"
                                    className="w-1/2 rounded-lg basic-multi-select"
                                    options={getAvailableOptions(index, processor)}
                                    value={EmployeeList.filter(
                                        (option) => processor
                                            .filter((_, i) => i == index)
                                            .flatMap((item) => item.employee_id).includes(option.value))
    ...
    return (
        ...
        >
            <div className="flex flex-col min-h-screen w-full" style={{ background: "var(--background)" }}>
                ...
                {/* Top bar */}
                <div
                    className="flex items-center justify-around px-6 py-4 border-b w-full"
                ...
                >
                    ...
                    <div className="space-y-2 w-3/5">
                        <div className="flex items-center gap-2">
                            <div className="flex gap-2 items-center">
                                ...
                                <input type="text" className="pl-2 border py-1 rounded bg-[#F3F4F8] text-sm w-40" />
                            </div>
                            <div className="flex gap-2 items-center">
                                <span className="text-nowrap">{"เอกสารของแผนก"}</span>
                                <Select options={DEPARTMENT_OPTIONS} className="w-52 rounded-lg">

                                </Select>
                            </div>
                            <div className="flex gap-2 items-center">
                                <span className="text-nowrap">{"เอกสารของบริษัท"}</span>
                                <Select options={COMPANY_OPTIONS} className="w-52 rounded-lg" />
                            </div>
                        </div>
                        <div className="text-nowrap">
                            <div className="flex gap-4 items-center">
                                <span className="text-nowrap">{"ผู้อนุมัติเอกสาร"}</span>
                                <RadioGroup defaultValue="current" value={employeeListStatus.approve} onValueChange={value => setEmployeeListStatus(prev => ({ ...prev, approve: value }))} className="w-fit flex">
                            ...
                            <div className={`flex gap-8 pl-4 mt-2 w-full ${employeeListStatus.approve === "current" ? "" : "hidden"}`}>
                                <button
                                    type="button"
                                ...
                                <div className="flex items-center w-full overflow-x-auto scrollbar-none">
                                    {approver[0].employee_id != "" && approver.map((app, index) => (
                                        <div className="flex">
                                            <span>{app.label}</span>
                                            {index != approver.length - 1 && <ArrowRight />}
                                        </div>
                                    ))}
                                </div>
                            </div>
                        ...
                        <div className="">
                            <div className="flex gap-4 items-center">
                                ...
                                <RadioGroup defaultValue="current" value={employeeListStatus.process} onValueChange={value => setEmployeeListStatus(prev => ({ ...prev, process: value }))} className="w-fit flex">
                                    <div className="flex items-center gap-3">
                            ...
                            <div className={`flex gap-8 pl-4 mt-2 w-full ${employeeListStatus.process === "current" ? "" : "hidden"}`}>
                                <button
                                    type="button"
                                    className="bg-[#4A4DF1] text-white w-36 px-2 py-0.5 min-w-36 rounded hover:cursor-pointer"
                        ...
                        <div className="">
                            <div className="flex gap-4 items-center">
                                ...
                                <RadioGroup defaultValue="current" value={employeeListStatus.finish} onValueChange={value => setEmployeeListStatus(prev => ({ ...prev, finish: value }))} className="w-fit flex">
                                    <div className="flex items-center gap-3">
                            ...
                            <div className={`pl-4 mt-2 ${employeeListStatus.finish === "current" ? "" : "hidden"}`}>
                                <div
                                    className={`flex pl-4 items-center mt-2 gap-2 `}
                                >
                                    <div className="flex gap-2 items-center">
                                    ...
                                    <Select
                                        ...
                                        className="w-2/5 rounded-lg basic-multi-select"
                                        defaultValue={{ label: "โปรดเลือกผู้สำเร็จเอกสาร", value: "1" }}
                                        options={EmployeeList.filter(em => em.value !== finisher.employee_id)}
                                        value={EmployeeList.find(option => option.value === finisher.employee_id) ?? null}
                                        onChange={(selected) => {
                                            if (!selected) return;
                    ...
                    <div className="flex items-center justify-end gap-2 w-1/5">
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 rounded-lg border transition-colors hover:bg-secondary hover:cursor-pointer"
                ...
                <div className="flex flex-1 overflow-hidden">
                    ...
                    {/* Left — Palette */}
                    <aside
                        className="flex flex-col w-1/5 shrink-0 border-r overflow-y-auto"
                    ...
                    {/* Right — Properties */}
                    <aside
                        className="w-1/5 shrink-0 border-l"
                        style={{ borderColor: "var(--border)", background: "var(--card)" }}
                    >
                        {selectedField ? (
                            <PropertiesPanel
            ...
            {modalStatus.approve && <EmployeeModal onClose={() => setModalStatus(prev => ({ ...prev, approve: false }))} type="ผู้อนุมัติ" List={approver} />}
            {modalStatus.process && <EmployeeModal onClose={() => setModalStatus(prev => ({ ...prev, process: false }))} type="ผู้ดำเนินการ" List={processor} />}
        </DndContext>
    );
}
