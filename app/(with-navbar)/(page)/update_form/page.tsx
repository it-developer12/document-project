...
export default function Page() {
    ...
    return (
        <div className={forms.length > 0 ? "bg-slate-50 min-h-screen h-full w-full p-6" : "bg-slate-50 min-h-screen h-full w-full p-6 flex justify-center items-center"}>
            { forms.length === 0 &&
                <div className="flex flex-col justify-center items-center gap-4 backdrop:blur-sm bg-white/30 rounded-xl p-10 shadow-lg">
                    <span className="text-2lx">{'ไม่พบรายการเอกสาร'}</span>
                </div>
            }
